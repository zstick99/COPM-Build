...
#
# 1.1: Added exception for stages
#	that set founder IDs to items
###################################
HOOK @ $80003FF0
{
	stwu r1, -0x20(r1)
...
AncestryLoop:
	...
	lwz r3, 8(r31)
	cmpwi r3, 0		# \ can be 0 if it is a stage that created
	beq- null		# / an item! Normally not seen in Brawl since the stage items don't think they have a founder.
	lwz r12, 0x3C(r3)
	lwz r12, 0xA4(r12)
	mtctr r12
	bctrl
